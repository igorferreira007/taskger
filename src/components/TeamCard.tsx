...
export function TeamCard({
  ...
  return (
    <div className="bg-background-tertiary rounded-lg overflow-hidden h-71 flex flex-col shadow-[0_4px_4px_0] shadow-black/25 cursor-pointer hover:brightness-110 transition">
